            ...
            <div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "1.25rem" }}>
                ...
                <div style={{ backgroundColor: "#1e293b", border: "1px solid #334155", padding: "1.25rem", borderRadius: "8px" }}>
                  ...
                  <small style={{ color: "#64748b" }}>Distributed mapping matrix</small>
                </div>

                <div style={{ backgroundColor: "#0c4a6e", border: "1px solid #0369a1", padding: "1.25rem", borderRadius: "8px" }}>
                  <span style={{ fontSize: "0.75rem", color: "#7dd3fc", fontWeight: "700", letterSpacing: "0.05em" }}>PERFORMANCE MULTIPLIER</span>
                  ...
                  <span style={{ fontSize: "0.8rem", color: "#7dd3fc" }}>Reduction in execution latency</span>
                </div>
